...
export default class App extends React.Component {
    constructor() {
        ...
        this._loadResourcesAsync = () => __awaiter(this, void 0, void 0, function* () {
            return Promise.all([
                ...
                Font.loadAsync(Object.assign({}, Ionicons.font, FontAwesome.font, EvilIcons.font, Entypo.font, { 
                    // We include SpaceMono because we use it in HomeScreen.js. Feel free
                    // to remove this if you are not using it in your app
                    'Raleway': require('../assets/fonts/Raleway-Regular.ttf'), 'RalewayBold': require('../assets/fonts/Raleway-Bold.ttf'), 'Lato': require('../assets/fonts/Lato-Regular.ttf'), 'LatoBold': require('../assets/fonts/Lato-Bold.ttf'), 'GreatVibes': require('../assets/fonts/GreatVibes-Regular.ttf'), 'QuickSandRegular': require('../assets/fonts/quicksand.book-regular.otf'), 'QuickSandBold': require('../assets/fonts/quicksand.bold-regular.otf') })),
                initClient(),
            ]);
        });
    ...
    render() {
        ...
        return (React.createElement(Provider, Object.assign({}, stores),
