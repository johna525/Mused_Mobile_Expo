...
import { View, TouchableWithoutFeedback, Text, StyleSheet, Dimensions, Image } from 'react-native';
    ...
    render() {
        return (React.createElement(View, { style: styles.container },
            ...
            React.createElement(View, { style: styles.content },
                React.createElement(Image, { source: welcomeImage, style: styles.welcomeImage }),
                React.createElement(View, { style: styles.videoContainer },
                    React.createElement(Video, { shouldPlay: true, resizeMode: Video.RESIZE_MODE_COVER, source: videoSource, isLooping: true, style: {
                            height: width * 1.5 / 3,
            ...
            React.createElement(View, { style: styles.buttonButtonView },
                ...
                React.createElement(TouchableWithoutFeedback, { onPress: () => this.onClickSkip() },
                    React.createElement(View, { style: styles.skipButton },
                        React.createElement(Text, { style: styles.skipButtonText }, "GO TO NEWSFEED"))))));
    }
}
